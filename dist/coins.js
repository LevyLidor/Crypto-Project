...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    let produtsContainer = document.querySelector('section.products');
...
;
function printProducts(coins, container) {
...
;
function allSearch(coins, produtsContainer) {
...
;
function createProductElement(coins) {
...
;
function createProductImageElement(coins) {
...
;
function createProductNameElement(coins) {
...
;
function createProductPriceElement(coins) {
...
;
function createProductDescriptionElement(coins) {
    let element = document.createElement('p');
    for (const coin of coins) {
...
;
function createProductToggle(coins) {
...
;
async function refreshCache(coin) {
    let coinData = await fetch(API_URL + '/' + coin.id).then(res => res.json());
    coinsCache[coin.id] = {
...
;
async function getCoinFromCache(coin) {
